...
/*
fun main(){
    val keyPair = CryptoUtils.generateCryptoKeys(2048)
    var message : String = "sidaosapfpas"
    println(message)
    var encryptedMessage = CryptoUtils.encryptMessage(keyPair.private, message.toByteArray())
    var decryptedMessage = CryptoUtils.decryptMessage(keyPair.public, encryptedMessage)
